 ...
 *
 * This file contains utility functions and structures used throughout the project,
 * including mathematical operations, file handling, and text formatting.
 *
 * @date April 22, 2025
 */
  ...
  *
  * Contains flags and parameters such as help display, source file paths, and algorithm settings.
  */
 struct ProgramOptions {
  ...
  *
  * This function processes the command-line arguments and extracts the program options.
  *
  ...
  *
  * This function reads the specified file and outputs its contents to the console.
  *
  ...
  *
  * This inline lambda function takes a string and centers it within the specified width
  * by adding padding spaces on both sides.
  *
  ...
  * considering a small tolerance value to account for floating-point precision errors.
  *
 ...
 /**
  * @brief Rounds a floating-point number to four decimal places.
  *
  * This function rounds the given number to four decimal places using standard rounding rules.
  *
  ...
  *
  * @param first The coordinates of the first point.
  * @param second The coordinates of the second point.
  ...
  *
  * This function searches for the first occurrence of a space character in the given string
